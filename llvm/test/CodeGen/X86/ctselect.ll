...
; X32-NOCMOV-NEXT:    andb $1, %dl
; X32-NOCMOV-NEXT:    negb %al
; X32-NOCMOV-NEXT:    movb %dl, %ah
; X32-NOCMOV-NEXT:    xorb $1, %ah
; X32-NOCMOV-NEXT:    andb %al, %ah
; X32-NOCMOV-NEXT:    xorb %dl, %ah
; X32-NOCMOV-NEXT:    andb $1, %ah
; X32-NOCMOV-NEXT:    movzbl %ah, %edx
