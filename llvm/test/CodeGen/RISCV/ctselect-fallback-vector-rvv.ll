...
; RUN: llc < %s -mtriple=riscv32 -mattr=+v,+zvl128b | FileCheck %s --check-prefix=RV32-V128
; RUN: llc < %s -mtriple=riscv64 -mattr=+v,+zvl256b | FileCheck %s --check-prefix=RV64-V256
