...
bool Sema::AttachTypeConstraint(AutoTypeLoc TL,
  ...
  ExprResult ImmediatelyDeclaredConstraint = formImmediatelyDeclaredConstraint(
      *this, TL.getNestedNameSpecifierLoc(), TL.getConceptNameInfo(),
      TL.getNamedConcept(), /*FoundDecl=*/TL.getFoundDecl(), LAngleLoc,
      RAngleLoc, BuildDecltypeType(Ref),
  ...
  if (TypeAliasTemplateDecl *AliasTemplate =
    ...
    if (!Decl) {
      ...
      Decl = ClassTemplateSpecializationDecl::Create(
          ...
          TagPattern->getLocation(), ClassTemplate, CTAI.CanonicalConverted,
...
DeclResult Sema::ActOnExplicitInstantiation(
  ...
  if (getLangOpts().LexicalTemplateInstantiation && ExternLoc.isValid() &&
    ...
    PrevDecl = ClassTemplateSpecializationDecl::Create(
        ...
        Pattern->getLocation(),
        PatternTpl, CTAI.CanonicalConverted,
